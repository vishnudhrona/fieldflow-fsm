import { useState, useRef, useEffect, type ReactNode, type ComponentType, type MouseEvent } from 'react';
      ...
      {isOpen &&
        ...
        createPortal(
          <div
            ...
            className='w-44 rounded-xl bg-white border border-slate-200 shadow-2xl py-1.5 focus:outline-none animate-in fade-in zoom-in-95 duration-100 text-left'
          >
