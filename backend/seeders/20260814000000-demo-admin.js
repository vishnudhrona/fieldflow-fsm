...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const admins = await queryInterface.sequelize.query(`SELECT id FROM users WHERE id = '00000000-0000-4000-8000-000000000002' LIMIT 1;`);
    ...
    const techs = await queryInterface.sequelize.query(`SELECT id FROM users WHERE id = '00000000-0000-4000-8000-000000000001' LIMIT 1;`);
